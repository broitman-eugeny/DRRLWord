...
class Cndex : public COleDispatchDriver
{
public:
	Cndex(){} // Calls COleDispatchDriver default constructor
	Cndex(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	Cndex(const Cndex& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
