...
// CTemplate wrapper class

class CTemplate : public COleDispatchDriver
{
public:
	CTemplate(){} // Calls COleDispatchDriver default constructor
	CTemplate(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CTemplate(const CTemplate& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
