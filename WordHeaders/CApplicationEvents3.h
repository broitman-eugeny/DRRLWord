...
// CApplicationEvents3 wrapper class

class CApplicationEvents3 : public COleDispatchDriver
{
public:
	CApplicationEvents3(){} // Calls COleDispatchDriver default constructor
	CApplicationEvents3(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CApplicationEvents3(const CApplicationEvents3& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
